...
int Automaton::numAutomatons = 0;

Automaton::Automaton()
{
    numAutomatons ++;
    startState = 1;
    automatonID = numAutomatons;
}
...
void Automaton::findEpsilons(State &startState, int curState, bool *used)
{
    if(used[curState])
        return;
    used[curState] = true;
    ...
    for(int i = 0; i < numTrans; i++)
    {
        ...
        else
        {
            ...
            findEpsilons(startState, neighbour, used);
        }
...
void Automaton::removeEpsilonTransitions()
{
    ...
    for(int i = 0; i < states.size(); i++)
    {
        ...
        this->findEpsilons(states[i], i, used);
